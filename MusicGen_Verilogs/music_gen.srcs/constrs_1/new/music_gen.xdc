...
set_property IOSTANDARD LVCMOS33 [get_ports forw15s_n]
set_property PACKAGE_PIN H16 [get_ports forw15s_n]
set_property IOSTANDARD LVCMOS33 [get_ports {list_index_i[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {list_index_i[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {list_index_i[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {list_index_i[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports back15s_n]
set_property PACKAGE_PIN J19 [get_ports back15s_n]
set_property PACKAGE_PIN F16 [get_ports {list_index_i[3]}]
set_property PACKAGE_PIN J14 [get_ports {list_index_i[2]}]
set_property PACKAGE_PIN G14 [get_ports {list_index_i[1]}]
set_property PACKAGE_PIN L15 [get_ports {list_index_i[0]}]
